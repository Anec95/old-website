...
langSelector.onchange = function() {
    if (langSelector.value === 'it') {
        ...
        bioText.innerHTML= ` Vivo secondo natura e provo a seguirne i dettami; ed è così che do vita ai miei progetti.
        ...
        più rilevanti in territorio italiano in ambito di danza contemporanea. Spesso ho ricevuto complimenti
        dall'associazione, ma anche dai gruppi di danzatori che frequentavano le sale dell'associazione, per
        le grafiche che sviluppavo per la promozione social.<br><br>Così, il 19 luglio 2022 ho deciso di tornare sui
        banchi di scuola per dare una svolta alla mia vita iniziando, tramite <a class="project-link" href='https://www.start2impact.it/master/digital-marketing/?utm_source=google&utm_medium=cpc&utm_campaign=Search_DigitalMKT&gclid=EAIaIQobChMI9P_ayKiu_AIVW49oCR3FLw1kEAAYASAAEgJlJPD_BwE'>start2impact</a>,
